...
class MovieFixtures extends Fixture implements DependentFixtureInterface
{
    ...
    public function __construct(CinemaRepository $cinemaRepository, TheaterRepository $theaterRepository)
    {
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $cinemaOneTheaters = $this->theaterRepository->findByCinemaId($cinemaOne->getId());
        ...
        $cinemaOneMovieOne->setTheater($cinemaOneTheaters[0]);
        ...
        $cinemaOneMovieTwo->setTheater($cinemaOneTheaters[1]);
        ...
        $cinemaTwoTheaters = $this->theaterRepository->findByCinemaId($cinemaTwo->getId());
        ...
        $cinemaTwoMovieOne->setTheater($cinemaTwoTheaters[0]);
        ...
        $cinemaTwoMovieTwo->setTheater($cinemaTwoTheaters[1]);
